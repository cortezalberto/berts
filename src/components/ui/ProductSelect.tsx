  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex gap-2">
        <select
          className="flex-1 px-3 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
  ...
  return (
    <div className="flex items-center gap-3 p-3 bg-zinc-800/50 rounded-lg">
      {product.image ? (
        ...
        <div className="w-10 h-10 rounded bg-zinc-700 flex items-center justify-center text-zinc-500 text-xs">
          -
        </div>
      )}
